...
#define ENC1_A 2   //Encoder 1A
#define ENC1_B 11  //Encoder 1B
#define ENC2_A 3   //Encoder 2A
#define ENC2_B 12  //Encoder 2B
...
void loop() {  
  long NewDistance = myEncA.read();   
     if (Distance < 1000)
     {
       goForwards();
       Distance = NewDistance * 0.7545;
